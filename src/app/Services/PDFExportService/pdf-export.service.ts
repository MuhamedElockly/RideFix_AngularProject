...
export class PDFExportService {
  ...
  /**
   * Generate an HTML report from the new dashboard statistics data
   */
  async generateDashboardStatisticsReport(
    dashboardStats: IDashboardStatistics,
    activitiesData: IActivitiesData | null,
    recentActivities: IActivity[]
  ): Promise<void> {
    try {
  ...
  private generateDashboardHTMLReport(
    dashboardStats: IDashboardStatistics,
    activitiesData: IActivitiesData | null,
    recentActivities: IActivity[]
  ): string {
    const currentDate = new Date().toLocaleString('ar-SA');
    const totalUsers = dashboardStats.users.technicians.count + dashboardStats.users.carOwners.count;
      ...
      <body>
        <div class="report-container">
          ...
          <div class="section">
            ...
            <div class="stat-item">
              <span class="stat-label">إجمالي الفنيين</span>
              <span class="stat-value">${dashboardStats.users.technicians.count}</span>
            </div>
            <div class="stat-item">
              <span class="stat-label">إجمالي أصحاب السيارات</span>
              <span class="stat-value">${dashboardStats.users.carOwners.count}</span>
            </div>
            <div class="stat-item">
              <span class="stat-label">إجمالي الطلبات</span>
              <span class="stat-value">${dashboardStats.requests.completed.count + dashboardStats.requests.waiting.count + dashboardStats.requests.active.count + dashboardStats.requests.canceled.count}</span>
            </div>
            <div class="stat-item">
              <span class="stat-label">الطلبات في الانتظار</span>
              <span class="stat-value">${dashboardStats.requests.waiting.count}</span>
            </div>
          </div>
          ...
          <div class="section">
            ...
            <div class="stat-item">
              ...
              <div>
                <span class="stat-value">${dashboardStats.users.technicians.count}</span>
                <span class="percentage">(${dashboardStats.users.technicians.percent}%)</span>
              </div>
            </div>
            <div class="stat-item">
              <span class="stat-label">أصحاب السيارات</span>
              <div>
                <span class="stat-value">${dashboardStats.users.carOwners.count}</span>
                <span class="percentage">(${dashboardStats.users.carOwners.percent}%)</span>
            </div>
            </div>
            <div class="stat-item">
              <span class="stat-label">المجموع</span>
          ...
          <div class="section">
            ...
            <div class="stat-item">
              <span class="stat-label">الطلبات المكتملة</span>
              <span class="stat-value">${dashboardStats.requests.completed.count}</span>
            </div>
            <div class="stat-item">
              <span class="stat-label">الطلبات في الانتظار</span>
              <span class="stat-value">${dashboardStats.requests.waiting.count}</span>
            ...
            <div class="stat-item">
              <span class="stat-label">الطلبات النشطة</span>
              <span class="stat-value">${dashboardStats.requests.active.count}</span>
            </div>
            <div class="stat-item">
              <span class="stat-label">الطلبات الملغية</span>
              <span class="stat-value">${dashboardStats.requests.canceled.count}</span>
            </div>
          </div>
          ...
          <div class="section">
            ...
            <div class="stat-item">
              ...
              <span class="stat-value">${dashboardStats.users.rates}/5</span>
            </div>
          </div>
